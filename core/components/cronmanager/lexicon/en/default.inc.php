...
$_lang['cronmanager.run_now_desc'] = 'The job will be run, no mater if disabled or already running.';
$_lang['cronmanager.run_now_title'] = 'Execute [[+job]] right now ?';
...
$_lang['cronmanager.remove_desc'] = 'Only the cron job will be removed, the snippet will be kept.';
$_lang['cronmanager.remove_title'] = 'Remove [[+job]] job ?';
$_lang['cronmanager.update'] = 'Update cronjob';
$_lang['cronmanager.update_desc'] = 'Update job options.';
$_lang['cronmanager.update_title'] = 'Update [[+job]]';
...
$_lang['cronmanager.log_detail'] = '<ul><li>Executed on : [[+on]]</li><li>Error(s) : [[+error]]</li></ul><br />';
...
$_lang['cronmanager.logs_title'] = 'View [[+job]] logs';
...
$_lang['cronmanager.log_none'] = 'There is currently no log available.';
...
$_lang['cronmanager.logs_errors'] = 'Errors';
...
$_lang['cronmanager.logs_total'] = 'Total';